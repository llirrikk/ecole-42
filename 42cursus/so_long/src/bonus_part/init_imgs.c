...
/*   Updated: 2022/01/31 18:02:57 by sserwyn          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_imgs(t_mlx *mlx, t_img *img)
{
	...
	img->enemy.enemy_left = init_img_utils(mlx->ptr, "./images/cat_left.xpm");
	img->enemy.enemy_right = init_img_utils(mlx->ptr, "./images/cat_right.xpm");
}
